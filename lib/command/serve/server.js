...
function getServer (options) {
  ...
  if (t.isDefined(options['max-connections'])) server.maxConnections = options['max-connections']
  if (t.isDefined(options['keepalive-timeout'])) server.keepAliveTimeout = options['keepalive-timeout']
